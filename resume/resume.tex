...
\header{saejin}{mahlau-heinert}
       {221 W. Bayview Blvd, Norfolk, VA, 23503 \newline \faMobilePhone (757)-777-4868 \faEnvelope saejinmh@gmail.com}

% In the aside, each new line forces a line break
\begin{aside}
  \section{about}
    \href{https://www.linkedin.com/in/saejinmh}{saejinmh \faLinkedin}
    \href{https://michionlion.github.io}{michionlion.github.io}
  \section{languages}
    bilingual french/english
    spanish \& italian notions
  \section{programming}
    {\color{red} $\varheartsuit$} {J}avascript
    ({ES5}, {N}ode.js)
    Python, C, OCaml
    CSS3 \& HTML5
\end{aside}
